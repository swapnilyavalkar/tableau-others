# Added assiciated field names in data source filters.
import pandas as pd
            ...
            for dataSourceItem in response.json()['data']['publishedDatasourcesConnection']['nodes']:
                ...
                if dataSourceItem['datasourceFilters']:
                    for datasourceFilter in dataSourceItem['datasourceFilters']:
                        datasourceFilterfieldItem = datasourceFilter['field']
                        if datasourceFilterfieldItem['__typename'] == 'CalculatedField':
                            datasourceFilterfieldFieldsItems = datasourceFilterfieldItem['fields']
                            for datasourceFilterfieldFieldsItem in datasourceFilterfieldFieldsItems:
                                df_datasourceFilters = df_datasourceFilters.append(
                                    {
                                        'DATA_SOURCE_NAME': dataSourceItem['name'],
                                        'DS_FIELD_NAME': datasourceFilter['field']['name'],
                                        'DS_FIELD_TYPE': datasourceFilter['field']['__typename'],
                                        'DS_FIELD_ASSOCIATED_NAME': datasourceFilterfieldFieldsItem['name'],
                                        'DS_FIELD_ASSOCIATED_TYPE': datasourceFilterfieldFieldsItem['__typename'],
                                    },
                                    ignore_index=True)
                        else:
                            df_datasourceFilters = df_datasourceFilters.append(
                                {
                                    ...
                                    'DS_FIELD_NAME': datasourceFilter['field']['name'],
                                    'DS_FIELD_TYPE': datasourceFilter['field']['__typename'],
                                    'DS_FIELD_ASSOCIATED_NAME': datasourceFilterfieldItem['name'],
                                    'DS_FIELD_ASSOCIATED_TYPE': '',
                                },
                                ignore_index=True)
                else:
                    df_datasourceFilters = df_datasourceFilters.append(
